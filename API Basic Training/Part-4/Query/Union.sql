...
-- SELECT DATA FROM FACULTY AND STUDENT TABLE with aggregate 
SELECT c01F01, c01f02, c01f03, c01f04, c01f05, c01f06, c01f07, c01f08,  count(c01f08) As Total_marks
FROM Fac01
group by c01f05
UNION ALL
SELECT d01F01, d01F02, d01F03, d01F04, d01F05, d01F06, d01F07, d01F08, sum(d01F08)
FROM Std01
group by d01F05
ORDER BY c01f02;
...
(SELECT n01f01, n01f02, n01f03, n01f04
 FROM Brn01)
ORDER BY k01f01 DESC, k01f02 ASC
LIMIT 10;



(SELECT P01F01, P01F02 FROM EMP01)
UNION ALL
(SELECT P01F01, P01F02 FROM DEP01)
UNION
(SELECT H01F04, H01F05 FROM SLH01);
