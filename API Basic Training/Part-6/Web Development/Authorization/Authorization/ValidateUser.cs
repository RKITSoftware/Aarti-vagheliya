...
namespace Authorization
{
    ...
    public class ValidateUser
    {
        ...
        public static bool Exist(string username, string password)
        {
            ...
            return UserController.UsersDeatil().Any(user => user.UserName.Equals(username) && user.Password == password);
        }
        ...
        public static User CollectUserDetail(string username, string password)
        {
            ...
            return UserController.UsersDeatil().FirstOrDefault(user => user.UserName.Equals(username) && user.Password == password);
