...
namespace Authorization.Controllers
{
    ...
    public class StudentController : ApiController
    {
        ...
        public HttpResponseMessage OneStudentDetails(int id)
        {
            ...
            return Request.CreateResponse(HttpStatusCode.OK, Student.StudentsDetail().FirstOrDefault(s => s.Id == id));
        ...
        public HttpResponseMessage FewStudentsDetails()
        {
            ...
            return Request.CreateResponse(HttpStatusCode.OK, Student.StudentsDetail().Where(s => s.Id < 5));
        }
        ...
        public HttpResponseMessage AllStudentsDetails()
        {
            ...
            return Request.CreateResponse(HttpStatusCode.OK, Student.StudentsDetail());
        }
        #endregion
