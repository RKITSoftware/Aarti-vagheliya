...
{
    // Enable CORS for the entire controller allowing only localhost origins, all headers, and all methods.
    [EnableCors(origins: "https://localhost:44331/", headers: "*", methods: "*")]
